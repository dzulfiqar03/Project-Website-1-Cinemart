...
function smoothScroll(id) {
    ...
    var scrollAnimate = setTimeout(function() { smoothScroll(id), 2 });
...
imageList1.addEventListener("mouseover", function() {
    ...
    imageList1.style.boxShadow = '-2px 2px 2px 1px #ffffff, 2px 2px 2px 1px #ffffff';
...
imageList1.addEventListener("mouseout", function() {
    imageList1.style.boxShadow = '0px 0px 0px 0px #ffffff, 0px 0px 0px 0px #ffffff';
...
imageList2.addEventListener("mouseover", function() {
    ...
    imageList2.style.boxShadow = '-2px 2px 2px 1px #ffffff, 2px 2px 2px 1px #ffffff'

    imageList2.style.transition = '1s all ease-in-out';
});
imageList2.addEventListener("mouseout", function() {
    imageList2.style.boxShadow = '0px 0px 0px 0px #ffffff, 0px 0px 0px 0px #ffffff';
...
imageList3.addEventListener("mouseover", function() {
    ...
    imageList3.style.boxShadow = '-2px 2px 2px 1px #ffffff, 2px 2px 2px 1px #ffffff'
...
imageList3.addEventListener("mouseout", function() {
    imageList3.style.boxShadow = '0px 0px 0px 0px #ffffff, 0px 0px 0px 0px #ffffff';
...
const movieList1 = [{
        ...
        sinopsys: "Journey into the unknown with Doctor Strange, with the help of mystical allies both old and new, across the stunning alternate reality...",
    ...
    },
    {
        ...
        sinopsys: "Four years after the destruction of the island of Nublar, dinosaurs now live and hunt alongside humans around the world. This delicate...",
    ...
    },
    {
        ...
        sinopsys: "The unexpected story of a twelve year old boy's dream to become the world's greatest super villain.",
    ...
    },
    {
        ...
        sinopsys: "A hit man, Alex Lewis discovers that he is being targeted after refusing to complete work for a dangerous criminal organization. Alex must quickly hunt down and kill the people ...",
    ...
    },
    {
        ...
        sinopsys: "With more than 30 years of service as one of the Navy's finest aviators, Pete Maverick Mitchell is in the position he's longed to be in,...",
    ...
    },
    {
        ...
        sinopsys: "When the Riddler, a sadistic serial killer begins murdering important political figures in Gotham, Batman is charged with investigating the city's...",
    ...
    },
    {
        ...
        sinopsys: "Professor Albus Dumbledore learns the powerful Dark wizard Gellert Grindelwald is on the move to rule the wizarding world. ...",
    ...
    },
    {
        ...
        sinopsys: "Dr. Robotnik returns to Earth with a new ally, Knuckles. Sonic and his new friend Tails will fight against them.",
...
const movieList2 = [{
        ...
        sinopsys: "The Avengers and their allies must be willing to sacrifice everything in an attempt to defeat the powerful Thanos before he succeeds in destroying the universe."
    ...
    },
    {
        ...
        sinopsys: "A strange black liquid from another world adheres to Peter Parker's body and causes his inner turmoil. At the same time, a new villain appears to threaten..."
    ...
    },
    {
        ...
        sinopsys: "Peter Parker (Tom Holland) is visiting Europe for a long vacation with his friends. Unfortunately, Parker could not calmly enjoy his vacation, because Nick Fury ..."
    },
    {
        id: 11,
        ...
        sinopsys: "Imprisoned, the great Thor finds himself in a deadly gladiatorial contest against the Hulk, his former ally. Thor must fight to survive and race against time to ..."
    },
    {
        id: 12,
        ...
        sinopsys: "Rose suffocates, while playing the elite society girl, attending parties, dressing up and constantly being scrutinized. When she met Jack on the Titanic, her life was changed forever."
    },
    {
        id: 13,
        ...
        sinopsys: "Peter Parker tries to balance his two very opposite lives - stopping Adrian Toomes' Chitauri gun sales and living his life like a high school student."
    },
    {
        id: 14,
        ...
        sinopsys: "This film reveals the origins of Arthur Curry, a mighty man who can control water and sea animals. Where did he get his power from? Who are his parents, and is he fit to be a king..."
    ...
    },
    {
        ...
        sinopsys: "Jake, a crippled marine, replaces his brother in Na'vi Pandora for a mission. After being accepted by the natives as part of them, he must decide where his allegiance is."
    },
];
...
const movieList3 = [{
    ...
    },
    {
        ...
        sinopsys: "Twenty-five years after a brutal murder shocked the quiet town of Woodsboro, a new assassin has donned the Ghostface mask and has begun to push a group of teenagers ..."
    ...
    },
    {
        ...
        sinopsys: "Biochemist Michael Morbius (Jared Leto) tries to cure himself of a rare blood disease, but accidentally infects his body and transforms into a vampire-like creature."
    },
    {
        id: 20,
        ...
        sinopsys: "Loretta Sage is a romantic novelist who likes to be alone, but her life changes when she goes on a book tour with and the handsome model on the cover of her latest novel."
    },
    {
        id: 21,
        ...
        sinopsys: "Nathan Drake is recruited by experienced treasure hunter Victor Sullivan (Sully) to return the wealth accumulated by Ferdinand Magellan and lost 500 years ago ..."
    },
    {
        id: 22,
        ...
        sinopsys: "In this highly suspenseful thriller from director-producers Michael Bay, veteran Will Sharp, desperate for money to cover his wife's medical bills,..."
    },
    {
        id: 23,
        ...
        sinopsys: "The Ice Age Adventures of Buck Wild continues the escapades of the possum brothers Crash and Eddie who set out to find a place of their own."
    },
];
